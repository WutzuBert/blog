...
2. 将该仓库复制一份到自己仓库
   ...
   ![image-20220709123438070](https://timepause.gitee.io/blog/image-20220709123438070.png)
   ...
   3. 下载自己仓库的代码
      ...
      ![image-20220709124109381](https://timepause.gitee.io/blog/image-20220709124109381.png)

      退当前出项目后选择 Get from VCS
      ![image-20220709124200795](https://timepause.gitee.io/blog/image-20220709124200795.png)
      将自己仓库地址复制至上面即可
      ![image-20220708183128744](https://timepause.gitee.io/blog/image-20220708183128744.png)
...
1.  进入根目录下的 _config.yml
   ![image-20220708182534247](https://timepause.gitee.io/blog/image-20220708182534247.png)
...
![image-20220709001623736](https://timepause.gitee.io/blog/image-20220709001623736.png)
...
1. **url 和 baseurl 这两个参数可以通过 gitee 的管理页查看**
   ![image-20220709124927889](https://timepause.gitee.io/blog/image-20220709124927889.png)

2. 第一次修改后, 后续再次修改 text_skin和 highlight_theme, 需要关闭网页, 然后清理缓存, 然后刷新才能访问到.
   ![image-20220708214716965](https://timepause.gitee.io/blog/image-20220708214716965.png)

### locale.yml

1. 修改版权时间信息  (这里如果拉取的是我的代码, 就不用改了, 因为我已经改过了~~~)
   这里本地化配置有很多种语言供我们选择, 但如果我们需要显示简体中文, 那么只要关注下面的配置即可
   ![ ](https://timepause.gitee.io/blog/image-20220708184905628.png)
   顺便说一句: 这里修改的本地化配置可以在  _config.yml 来指定
   ![image-20220709130111849](https://timepause.gitee.io/blog/image-20220709130111849.png)



2. 提交并推送代码到指定仓库
   ![image-20220708185429998](https://timepause.gitee.io/blog/image-20220708185429998.png)
...
1. 点击Gitee Pages
   ![image-20220708185748068](https://timepause.gitee.io/blog/image-20220708185748068.png)



2. 身份认证
   经过第1步操作之后, 如果之前没有实名制认证, 则需要认证环节(这个才是最费时间的环节)
   ![image-20220708185926878](https://timepause.gitee.io/blog/image-20220708185926878.png)

​		填写后, 还需要上传身份证照片等相关信息
![image-20220708190155215](https://timepause.gitee.io/blog/image-20220708190155215.png)

3. 构建和部署
   一般在工作日时, 审核时间大概是一天左右(周末不清楚, 可能会晚些), 审核成功之后, 再次点击 Gitee Pages, 会出现下面窗口
   		![image-20220708190528178](https://timepause.gitee.io/blog/image-20220708190528178.png)		部署成功后, 点击地址即可
   ![image-20220708190616650](https://timepause.gitee.io/blog/image-20220708190616650.png)

​			点击上图超链接即可访问
​			![image-20220709131005102](https://timepause.gitee.io/blog/image-20220709131005102.png)
...
1. 将 .md (markdown) 格式的文件上传至 项目根目录下的 _post 目录下
   ![image-20220709134159346](https://timepause.gitee.io/blog/image-20220709134159346.png)
...
2.  我们一般会在博客中上传图片, 因此我们需要将图片资源手动放到, 根目录/asserts/imgs/ 下.
   ...
   ![image-20220709135122068](https://timepause.gitee.io/blog/image-20220709135122068.png)
...
1. 我们可以以日期为目录, 然后按日期来存放. 而且这种方式因为目录层级少, 图片可以直接显示
   ![image-20220709135233237](https://timepause.gitee.io/blog/image-20220709135233237.png)

2. 如果是团队博客的话, 可以以自己名字+时间为目录存放图片
   ![image-20220709135529561](https://timepause.gitee.io/blog/image-20220709135529561.png)
